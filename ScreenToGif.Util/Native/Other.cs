...
public class Other
{
    ...
    public static void DrawFrame(IntPtr hWnd, double scale)
    {
        ...
        Gdi32.PatBlt(hdc, rect.Left, rect.Top, rect.Right - rect.Left, frameWidth, ScreenToGif.Native.Constants.DstInvert);

        Gdi32.PatBlt(hdc, rect.Left, rect.Bottom - frameWidth, frameWidth, -(rect.Bottom - rect.Top - 2 * frameWidth), ScreenToGif.Native.Constants.DstInvert);

        Gdi32.PatBlt(hdc, rect.Right - frameWidth, rect.Top + frameWidth, frameWidth, rect.Bottom - rect.Top - 2 * frameWidth, ScreenToGif.Native.Constants.DstInvert);

        Gdi32.PatBlt(hdc, rect.Right, rect.Bottom - frameWidth, -(rect.Right - rect.Left), frameWidth, ScreenToGif.Native.Constants.DstInvert);
    }
