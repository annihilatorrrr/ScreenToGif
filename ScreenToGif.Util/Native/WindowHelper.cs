    ...
    public static class WindowHelper
    {
        ...
        public static List<DetectedRegion> EnumerateWindows(double scale = 1)
        {
            ...
            User32.EnumDesktopWindows(IntPtr.Zero, delegate (IntPtr handle, IntPtr lParam)
            {
                ...
                if ((infoTile.rgstate[0] & ScreenToGif.Native.Constants.StateSystemUnavailable) == ScreenToGif.Native.Constants.StateSystemUnavailable)
                    return true;
        ...
        {
            var pointer = User32.MonitorFromWindow(handle, ScreenToGif.Native.Constants.MonitorDefaultToNearest);
        ...
        {
            var pointer = User32.MonitorFromPoint(new PointW { X = left, Y = top }, ScreenToGif.Native.Constants.MonitorDefaultToNearest);
