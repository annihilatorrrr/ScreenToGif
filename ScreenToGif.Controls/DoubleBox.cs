...
public class DoubleBox : ExTextBox
{
    #region Variables
    ...
    public static readonly DependencyProperty MaximumProperty = DependencyProperty.Register(nameof(Maximum), typeof(double), typeof(DoubleBox), new FrameworkPropertyMetadata(double.MaxValue, OnMaximumPropertyChanged));

    public static readonly DependencyProperty ValueProperty = DependencyProperty.Register(nameof(Value), typeof(double), typeof(DoubleBox), new FrameworkPropertyMetadata(0D, OnValuePropertyChanged));

    public static readonly DependencyProperty MinimumProperty = DependencyProperty.Register(nameof(Minimum), typeof(double), typeof(DoubleBox), new FrameworkPropertyMetadata(0D, OnMinimumPropertyChanged));

    public static readonly DependencyProperty DecimalsProperty = DependencyProperty.Register(nameof(Decimals), typeof(int), typeof(DoubleBox), new FrameworkPropertyMetadata(2, OnDecimalsPropertyChanged));

    public static readonly DependencyProperty StepProperty = DependencyProperty.Register(nameof(StepValue), typeof(double), typeof(DoubleBox), new FrameworkPropertyMetadata(1D));

    public static readonly DependencyProperty UpdateOnInputProperty = DependencyProperty.Register(nameof(UpdateOnInput), typeof(bool), typeof(DoubleBox), new FrameworkPropertyMetadata(false));

    public static readonly DependencyProperty DefaultValueIfEmptyProperty = DependencyProperty.Register(nameof(DefaultValueIfEmpty), typeof(double), typeof(DoubleBox), new FrameworkPropertyMetadata(0D));

    public static readonly RoutedEvent ValueChangedEvent = EventManager.RegisterRoutedEvent(nameof(ValueChanged), RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(DoubleBox));
    ...
    {
        if (d is not DoubleBox doubleBox)
            return;
    ...
    private static void OnValuePropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
    {
        ...
        {
            var value = string.Format(CultureInfo.CurrentCulture, doubleBox._format, doubleBox.Value);
    ...
    protected override void OnTextChanged(TextChangedEventArgs e)
    {
        ...
        Value = Math.Round(Convert.ToDouble(Text, CultureInfo.CurrentCulture), Decimals);
