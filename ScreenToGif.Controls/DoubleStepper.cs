...
public class DoubleStepper : DoubleBox
{
    ...
    static DoubleStepper()
    {
        DefaultStyleKeyProperty.OverrideMetadata(typeof(DoubleStepper), new FrameworkPropertyMetadata(typeof(DoubleStepper)));
    }
