...
public class IntegerStepper : IntegerBox
{
    ...
    static IntegerStepper()
    {
        DefaultStyleKeyProperty.OverrideMetadata(typeof(IntegerStepper), new FrameworkPropertyMetadata(typeof(IntegerStepper)));
    }
