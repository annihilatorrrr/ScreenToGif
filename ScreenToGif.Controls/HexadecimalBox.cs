...
public class HexadecimalBox : ExTextBox
{
    public static readonly DependencyProperty RedProperty = DependencyProperty.Register(nameof(Red), typeof(int), typeof(HexadecimalBox), new PropertyMetadata(0, Value_PropertyChanged));

    public static readonly DependencyProperty GreenProperty = DependencyProperty.Register(nameof(Green), typeof(int), typeof(HexadecimalBox), new PropertyMetadata(0, Value_PropertyChanged));

    public static readonly DependencyProperty BlueProperty = DependencyProperty.Register(nameof(Blue), typeof(int), typeof(HexadecimalBox), new PropertyMetadata(0, Value_PropertyChanged));

    public static readonly DependencyProperty AlphaProperty = DependencyProperty.Register(nameof(Alpha), typeof(int), typeof(HexadecimalBox), new PropertyMetadata(255, Value_PropertyChanged));

    public static readonly DependencyProperty DisplayGlyphProperty = DependencyProperty.Register(nameof(DisplayGlyph), typeof(bool), typeof(HexadecimalBox), new PropertyMetadata(true));

    public static readonly DependencyProperty DisplayAlphaProperty = DependencyProperty.Register(nameof(DisplayAlpha), typeof(bool), typeof(HexadecimalBox), new PropertyMetadata(true));

    public static readonly RoutedEvent ValueChangedEvent = EventManager.RegisterRoutedEvent(nameof(ValueChanged), RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(HexadecimalBox));
    ...
    {
        if (o is not HexadecimalBox hexaBox)
            return;
