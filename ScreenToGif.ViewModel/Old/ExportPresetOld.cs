...
public abstract class ExportPresetOld : BindableBase, IExportPreset
{
    ...
    public ExportPresetOld ShallowCopy()
    {
        return (ExportPresetOld) MemberwiseClone();
    }
}