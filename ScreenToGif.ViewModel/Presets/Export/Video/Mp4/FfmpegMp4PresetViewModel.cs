...
using ScreenToGif.Domain.Models.Preset.Export.Video.Mp4;
using ScreenToGif.Util;

namespace ScreenToGif.ViewModel.Presets.Export.Video.Mp4;

public class FfmpegMp4PresetViewModel : Mp4PresetViewModel, IFfmpegPreset
{
    public FfmpegMp4PresetViewModel()
    {
    ...
    public static List<FfmpegMp4PresetViewModel> Defaults => new()
    {
        new FfmpegMp4PresetViewModel
        {
    ...
    public override FfmpegMp4Preset ToModel()
    {
        return new FfmpegMp4Preset
        {
            Title = Title,
            TitleKey = TitleKey,
