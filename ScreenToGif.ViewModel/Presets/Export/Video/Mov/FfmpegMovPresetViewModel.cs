...
using ScreenToGif.Domain.Models.Preset.Export.Video.Mov;
using ScreenToGif.Util;

namespace ScreenToGif.ViewModel.Presets.Export.Video.Mov;

public class FfmpegMovPresetViewModel : MovPresetViewModel, IFfmpegPreset
{
    public FfmpegMovPresetViewModel()
    {
    ...
    public static List<FfmpegMovPresetViewModel> Defaults => new()
    {
        new FfmpegMovPresetViewModel
        {
    ...
    public override FfmpegMovPreset ToModel()
    {
        return new FfmpegMovPreset
        {
            Title = Title,
            TitleKey = TitleKey,
